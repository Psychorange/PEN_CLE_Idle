...
public class Power2 : MonoBehaviour
{
    ...
    public void OnClic()
    {
        ...
        goldManager.actionLevel += 1;
        goldManager.ALevelText.text = goldManager.actionLevel.ToString("000");
        goldManager.action = Mathf.RoundToInt(goldManager.action * 2.6f);
        goldManager.AText.text = goldManager.action.ToString("0000000");
        goldManager.actionCost = Mathf.RoundToInt(goldManager.actionCost * 2.6f);
